...
/****首页轮播广告商品****/
CREATE TABLE pro_index_carousel(
  cid INT PRIMARY KEY AUTO_INCREMENT,
  img VARCHAR(128),
  title VARCHAR(64),
  href VARCHAR(128)
...
INSERT INTO pro_index_carousel VALUES(1,'img/hero-slider/slider-1.jpg','Featured Product,Summer Cloths','product_details.html?lid=1');
INSERT INTO pro_index_carousel VALUES(2,'img/hero-slider/slider-2.jpg','Featured Product,Summer Cloths','product_details.html?lid=2');
INSERT INTO pro_index_carousel VALUES(3,'img/hero-slider/slider-3.jpg','Featured Product,Summer Cloths','product_details.html?lid=3');
/****首页商品****/
